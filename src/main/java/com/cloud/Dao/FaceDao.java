...
//        String value = JSON.toJSONString(list);
    ...
    public int searchUniqueIdbyInfo(String name,String workunit,String sex,String occupation){
        ...
        Object args[] = {name,workunit,sex,occupation};
        Integer maxid = jdbcTemplate.queryForObject(sql,args,Integer.class);
        return maxid;
    }
    /*
    查找图片存放在本地的路径
    */
    public String searchPicUrlbyUniqueId(int uniqueid){
        String sql = "select IMAGEPATH from USER where UNIQUEID = "+uniqueid;
        String imagePath = jdbcTemplate.queryForObject(sql,String.class);
        return null;
